...
$sql="update  tblbooks set BookName=:bookname,CatId=:category,TotalCopies=:total,AvailableNoOfBooks=:available,LocationOfBook=:location,AuthorId=:author,BookPrice=:price where id=:bookid";
...
<div class="col-md-6">
 ...
 <div class="col-md-6">
 <div class="form-group">
 <label>Total no.of Copies of the Book<span style="color:red;">*</span></label>
 <input class="form-control" type="text" name="total" value="<?php echo htmlentities($result->TotalCopies);?>"   required="required" />
 </div></div>

 <div class="col-md-6">
 <div class="form-group">
 <label>No.of Book Copies Available<span style="color:red;">*</span></label>
 <input class="form-control" type="text" name="available" value="<?php echo htmlentities($result->AvailableNoOfBooks);?>"   required="required" />
 </div></div>

 <div class="col-md-6">
 <div class="form-group">
 <label>Location of the Book<span style="color:red;">*</span></label>
 <input class="form-control" type="text" name="location" value="<?php echo htmlentities($result->LocationOfBook);?>"   required="required" />
 </div></div>

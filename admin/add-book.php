...
$sql="INSERT INTO  tblbooks(BookName,CatId,AuthorId,ISBNNumber,BookPrice,bookImage,TotalCopies,AvailableNoOfBooks,LocationOfBook) VALUES(:bookname,:category,:author,:isbn,:price,:imgnewname,:total,:available,:location)";
...
<div class="col-md-6">  
 <div class="form-group">
 <label>Total No.of Book Copies<span style="color:red;">*</span></label>
 <input class="form-control" type="text" name="total" autocomplete="off"   required="required" />
 </div>
</div>

<div class="col-md-6">  
 <div class="form-group">
 <label>Available No.of Book Copies<span style="color:red;">*</span></label>
 <input class="form-control" type="text" name="available" autocomplete="off"   required="required" />
 </div>
</div>

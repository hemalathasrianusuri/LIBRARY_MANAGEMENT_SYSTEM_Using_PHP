                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
<?php $sql = "SELECT tblbooks.BookName,tblcategory.CategoryName,tblauthors.AuthorName,tblbooks.ISBNNumber,tblbooks.TotalCopies,tblbooks.AvailableNoOfBooks,tblbooks.LocationOfBook,tblbooks.BookPrice,tblbooks.RegDate,tblbooks.UpdationDate,tblbooks.id as bookid,tblbooks.bookImage from  tblbooks join tblcategory on tblcategory.id=tblbooks.CatId join tblauthors on tblauthors.id=tblbooks.AuthorId";
$query = $dbh -> prepare($sql);
$query->execute();
...
<img src="bookimg/<?php echo htmlentities($result->bookImage);?>" width="100">
                                            ...
                                            <td class="center"><?php echo htmlentities($result->TotalCopies);?></td>
                                            <td class="center"><?php echo htmlentities($result->AvailableNoOfBooks);?></td>
                                            <td class="center"><?php echo htmlentities($result->LocationOfBook);?></td>
